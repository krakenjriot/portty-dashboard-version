        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="user" action="?p=4" method="post">
              ...
              <div class="form-group ipaddress">
              ...
              <div class="form-group server_refresh_sec">
                <label for="server_refresh_sec" class="col-form-label">server_refresh_sec:</label>
                <input class="form-control" id="server_refresh_sec" name="server_refresh_sec" value="<?php echo "ffff" ?>" ></input>
              </div>			  
