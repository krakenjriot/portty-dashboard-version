...
if ($server_ip_local == $ipaddress || $server_ip_local == "127.0.0.1") $online_text = "<span class'text-success'>Local</span>";
                ...
                <div class="card border-left-primary shadow h-100 py-2 bg-gradient-primary">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      ...
                      <div class="col-auto">
                        <i class="fas fa-microchip fa-2x text-gray-100"></i>											
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card border-left-primary shadow h-100 py-2 bg-gradient-primary">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      ...
                      <div class="col-auto">
                        <i class="fas fa-toggle-on fa-2x text-gray-100"></i>											
                      </div>
                    </div>
                  </div>
                </div>
...
if (mysqli_num_rows($result) > 0)
{
    ...
    while ($row = mysqli_fetch_assoc($result))
    {
		...
		if($row["active"]){
			$active = "<i class='far fa-check-circle fa-2x'></i>";
		} else {
			$active = "<i class='far fa-times-circle fa-2x'></i>";
		}		
				
		if($row["web_service"]){
			$web_service = "<i class='far fa-check-circle fa-2x'></i>";
		} else {
			$web_service = "<i class='far fa-times-circle fa-2x'></i>";
		}			
		
		if($row["web_page"]){
			$web_page = "<i class='far fa-check-circle fa-2x'></i>";
		} else {
			$web_page = "<i class='far fa-times-circle fa-2x'></i>";
		}

		if($row["_default"]){
			$_default = "<i class='far fa-check-circle fa-2x'></i>";
		} else {
			$_default = "<i class='far fa-times-circle fa-2x'></i>";
		}		
        ...
        "<td><a href='#' data-toggle='modal' data-target='#delServer' class='btn btn-danger btn-circle btn-sm' data-whatever='" . $row["server_name"] . "'><i class='far fa-trash-alt fa-2x'></a></td>" . "<td><a href='#' data-toggle='modal' data-target='#editServer' class='btn btn-danger btn-circle btn-sm' 
...
?>
            ...
            <div class="card shadow mb-4">
              <div class="card-header py-3">
				...
				<a href='batchfile/xloader.bat' download class="btn btn-primary btn-icon-split">
                <span class="icon text-white-50">
                <i class="fas fa-flag"></i>
                </span>
...
if (mysqli_num_rows($result) > 0)
{
    ...
    while ($row = mysqli_fetch_assoc($result))
    {
        ...
        echo "<tr>" . "<td><a href='#' data-toggle='modal' data-target='#delBoard' class='btn btn-danger btn-circle btn-sm' data-whatever='" . $row["board_name"] . "'><i class='far fa-trash-alt fa-2x'></i></a></td>" . "<td><a href='#' data-toggle='modal' data-target='#editBoard' class='btn btn-danger btn-circle btn-sm' 
									...
									"<td><a href='batchfile/" . $row["board_name"] . ".porttymon.bat' download><i class='fas fa-arrow-circle-down fa-2x'></i></a></td>" .
...
if (mysqli_num_rows($result) > 0)
{
    ...
    while ($row = mysqli_fetch_assoc($result))
    {
        ...
        echo "<tr>" . "<td><a href='#' data-toggle='modal' data-target='#editPin' class='btn btn-danger btn-circle btn-sm' 
									...
									"<td>" . $row["board_name"] . "</td>" . 
									"<td>" . $row["pin_num"] . "</td>" . 
									"<td>" . $row["pin_name"] . "</td>" . "<td>" . $row["pin_desc"] . "</td>" . "</tr>";
    }
}
else
{
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="user" action="?p=4" method="post">
              ...
              <div class="form-group ">
                <label for="ipaddress" class="col-form-label">ipaddress:</label>
                <input type="text" class="form-control" id="ipaddress" name="ipaddress" value="<?php echo $ipaddress; ?>" >
              </div>				  
